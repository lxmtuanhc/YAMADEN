...
export const SCHEDULE_STATUSES: ScheduleStatus[] = ["pending", "confirmed", "rescheduled", "completed", "cancelled"];
...
export const SCHEDULE_FILTERS: Array<{ id: ScheduleStatus | "all"; key: TranslationKey }> = [
  ...
  { id: "pending", key: "schedule.statusPending" },
  { id: "confirmed", key: "schedule.statusConfirmed" },
  { id: "rescheduled", key: "schedule.statusRescheduled" },
